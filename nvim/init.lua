require("mine.settings")        -- general nvim settings
require("mine.keymaps")         -- keymaps
require("mine.commands")        -- vim commands
require("mine.autocommands")    -- autocmd
require("mine.abbreviations")   -- iab / spell check corrections
require("mine.functions")       -- custom VIM functions
